...
int main() {
    ...
    ifstream in ("C:\\myfiles\\MyClionProjects\\untitled\\in");
    ...
    ofstream out ("C:\\myfiles\\MyClionProjects\\untitled\\out");
    out<<"Номер вашего подмножества в кодах Грея: "<<result+1;
